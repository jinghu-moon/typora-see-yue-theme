...
- [1.1 主题使用](#1.1 主题使用) 
- <a href="1.1 主题使用">1.1 主题使用</a>
- [1.2 主题介绍](# 1.2 主题介绍) 
  - [1.2.1 设计思路](# 1.2.1 设计思路) 
  - [1.2.2 注意](# 1.2.2 注意) 
- [1.3 主题文件](# 1.3 主题文件) 
  - [1.3.1 资源文件](# 1.3.1 资源文件) 
  - [1.3.2 CSS 文件](# 1.3.2 CSS 文件) 
- [1.4 主题功能](# 1.4 主题功能) 
  - [1.4.1 标题等级提示](# 1.4.1 标题等级提示) 
  - [1.4.2 自动编号](# 1.4.2 自动编号) 
  - [1.4.3 代码块显示编程语言 ](# 1.4.3 代码块显示编程语言)
  - [1.4.4 网络图片标识](# 1.4.4 网络图片标识) 
  - [1.4.5 图片错误显示](# 1.4.5 图片错误显示) 
  - [1.4.6 链接图标](# 1.4.6 链接图标) 
  - [1.4.7 侧边栏大纲线](# 1.4.7 侧边栏大纲线) 
  - [1.4.8 正文目录设置](# 1.4.8 正文目录设置) 
  - [1.4.9 列表设置](# 1.4.9 列表设置) 
  - [1.4.10 波浪线效果](# 1.4.10 波浪线效果) 
  - [1.4.11 引用样式块](# 1.4.11 引用样式块) 
  - [1.4.12 summary 折叠标签](# 1.4.12 summary 折叠标签) 
  - [1.4.13 毛玻璃效果](# 1.4.13 毛玻璃效果) 
- [1.5 参考主题 ](# 1.5 参考主题) 
- [1.6 主题 Bug](# 1.6 主题 Bug) 
- [1.7 结束语](# 1.7 结束语) 
...
See Yue 主题针对**中文**做了优化。See Yue 译为**望月**。
