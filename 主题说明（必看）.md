...
蓝奏云下载链接： https://xianchengyue.lanzout.com/b026y85of ，密码：c7c3。打不开，请将 `lanzout` 换成 `lanzoui` / `lanzous` / `lanzoux` 。
...
- 侧边栏和底部栏统一使用 LXGWWenKai+RobotoMono 的合并字体，即是 <a href="https://www.maoken.com/freefonts/9704.html" target="_blank">霞鹜文楷</a>  的中文 + [RobotoMono](https://github.com/googlefonts/roboto) 的英文。做到缩进一致，区分侧边栏与写作区。
...
链接默认末尾增加一个小链接图标，部分网站链接首端有对应网站 logo。如下图：
